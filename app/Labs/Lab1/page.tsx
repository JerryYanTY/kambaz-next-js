      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <textarea id="wd-textarea" cols={30} rows={10} defaultValue="
            ...
            turpis. Nullam sem nunc, bibendum in leo sed, ultricies commodo
            dolor. Suspendisse nec fermentum magna. Ut eleifend metus mauris,
            non efficitur velit venenatis hendrerit. Donec molestie mattis nunc.
          ...
          <input type="date" defaultValue="2025-09-16" id="wd-text-fields-dob" />
          <br/>
        </form>
      </div>
      <h4>Anchor tag</h4>
