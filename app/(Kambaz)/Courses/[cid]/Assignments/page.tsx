    ...
    <div id="wd-assignments">
      ...
      <ul id="wd-assignment-list">
        <li className="wd-assignment-list-item">
          <a href="/Courses/1234/Assignments/1" className="wd-assignment-link">
            A1 - ENV + HTML
          </a>
          <br />
        ...
        <li className="wd-assignment-list-item">
          <a href="/Courses/1234/Assignments/2" className="wd-assignment-link">
            A2 - CSS + BOOTSTRAP
          </a>
          <br />
        ...
        <li className="wd-assignment-list-item">
          <a href="/Courses/1234/Assignments/3" className="wd-assignment-link">
            A3 - JAVASCRIPT + REACT
          </a>
          <br />
